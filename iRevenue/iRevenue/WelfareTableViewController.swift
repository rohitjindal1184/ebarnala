//
//  WelfareTableViewController.swift
//  iRevenue
//
...
class WelfareTableViewController: UITableViewController, DetailCellProtocol {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell?.delegate = self
        cell?.color = UIColor.colorFromCode(0x82C5E5)
        cell?.loadData()
    ...
    func getDEO() {
        ...
        let tehsilQuery = PFQuery(className: "DWO")
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let latitude = Double((selection?.object(forKey: "latitude") as? String)!)!
        let longitude = Double((selection?.object(forKey: "longitude") as? String)!)!
        directionVC?.destination = CLLocation(latitude: latitude, longitude: longitude)
